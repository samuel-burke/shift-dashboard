...
- Auto-generated draft schedules — one tap fills a week from the coverage curves, respecting availability, approved time off, call-outs, desired weekly hours, and the 40-hour overtime cap; auto-managed weeks regenerate on the fly when any of those inputs change, while manually placed shifts stay put
