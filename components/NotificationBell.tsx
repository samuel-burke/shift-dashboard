...
const TYPE_ICON_MAP: Record<string, { Icon: (p: { size?: number; color?: string }) => React.ReactElement | null; color: string }> = {
  ...
  availability_request:  { Icon: CalendarIcon,        color: "#fbbf24" },
  availability_approved: { Icon: TimeOffApprovedIcon, color: "#34d399" },
  availability_denied:   { Icon: TimeOffDeniedIcon,   color: "#f87171" },
